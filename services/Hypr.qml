...
Singleton {
    ...
    function reloadDynamicConfs(): void {
        extras.batchMessage(["keyword bindlni ,Caps_Lock,global,ferret:refreshDevices", "keyword bindlni ,Num_Lock,global,ferret:refreshDevices"]);
    }
    ...
    FileView {
        ...
        path: Quickshell.env("FERRET_XKB_RULES_PATH") || "/usr/share/X11/xkb/rules/base.lst"
        onLoaded: {
